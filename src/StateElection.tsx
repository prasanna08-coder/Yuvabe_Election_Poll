      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            ...
            {view === "admin" || view === "state_insights" ? (
              <button 
              ...
              >
                <LogOut size={12} className="group-hover:scale-110 transition-transform" /> Exit Admin
              </button>
            ) : (
              <button 
                ...
                className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/40 hover:text-white transition-colors flex items-center gap-2 group"
              >
                <Lock size={12} className="group-hover:scale-110 transition-transform" /> Admin Portal
              </button>
            )}
          </div>
        </div>
                    ...
                    >
                      ...
                      <div className="space-y-8 relative z-10">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-white/30 font-mono">{dVotes} Votes</p>
                        </div>
                      </div>
                    </motion.button>
                  );
